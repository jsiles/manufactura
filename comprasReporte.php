...
$format_end =& $workbook->addFormat(array('Size' => 8,
					...
					foreach($arrayProducto as $key=>$value)
					{
						...
						$MillonesComprasPedido0 = get_db_value("select sum(tot_sumatotal) from tb_totalcompras where tot_tiempototal=" . tosql($aux0,"Number") . " and tot_pro_id and tot_usu_id=".tosql($user_id,"Number")." and tot_jue_id = ".tosql($jue_id,"Number")." and tot_per_id=".tosql($per_id,"Number"));
						...
						$UnidadesComprasPedido1 = get_db_value("select sum(tot_productototal) from tb_totalcompras where tot_tiempototal=" . tosql($aux1,"Number") . " and tot_pro_id and tot_usu_id=".tosql($user_id,"Number")." and tot_jue_id = ".tosql($jue_id,"Number")." and tot_per_id=".tosql($per_id,"Number"));
