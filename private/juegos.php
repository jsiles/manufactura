        ...
        if(($ShownRecords < $this->PageSize) && $this->DataSource->next_record())
        {
            do {
                ...
                if(!$this->IsAltRow)
                {
                    ...
                    $this->Link15->Parameters = CCAddParam($this->Link15->Parameters, "jue_id", $this->DataSource->f("jue_id"));
					...
					$this->Link23->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                    $this->Link23->Parameters = CCAddParam($this->Link23->Parameters, "jue_id", $this->DataSource->f("jue_id"));
					$this->Link23->Parameters = CCAddParam($this->Link23->Parameters, "per_ini", $this->DataSource->f("jue_periodoInicial"));
                    $this->Link23->Parameters = CCAddParam($this->Link23->Parameters, "cant", $this->DataSource->f("jue_cantidad"));
                ...
                else
                {
					...
					$this->Link16->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                    $this->Link16->Parameters = CCAddParam($this->Link16->Parameters, "jue_id", $this->DataSource->f("jue_id"));
					...
					$this->Link24->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                    $this->Link24->Parameters = CCAddParam($this->Link24->Parameters, "jue_id", $this->DataSource->f("jue_id"));
					$this->Link24->Parameters = CCAddParam($this->Link24->Parameters, "per_ini", $this->DataSource->f("jue_periodoInicial"));
                    $this->Link24->Parameters = CCAddParam($this->Link24->Parameters, "cant", $this->DataSource->f("jue_cantidad"));
